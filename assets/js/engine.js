...
function displayData(data, county) {
    ...
    if (shopsfound != 1){
        document.getElementById("container-row").innerHTML = '<div class="col-12 text-center">Looks like there are no shops in your county yet!</div><div class="col-12 mt-4 text-center"><h4>Check out shops in your region!</h4></div><div class="col-12 mt-3 mb-5 pb-5"> <div class="select-county-btn-desktop text-center" data-toggle="modal" data-target="#provModal">Select A Region <i class="fas fa-angle-down ml-3"></i></div></div>';
    }
