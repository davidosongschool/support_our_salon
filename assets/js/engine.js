...
function random(){
    ...
    document.getElementById("container-row").innerHTML += '<div class="col-12 col-md-6 col-lg-4 contain-salon mt-3 dublin"><a href="' + shop.shops[rand[0]].Link + '"><img src="' + shop.shops[rand[0]].Image + '" alt="' + shop.shops[rand[0]].Name +'" class="screenshot shadow-sm"></a><div class="contain-info mt-3 d-inline-block p-0">' + shop.shops[rand[0]].Name +  '</div><div class="contain-location mt-3 d-inline-block p-0"><div class="county-tag ml-auto">' +  shop.shops[rand[0]].County +  '</div></span></div></div>' 
